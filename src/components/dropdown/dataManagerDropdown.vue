<template>
    <div>
        <div class="flex justify-end pt-2 items-center space-x-2">
            ...
            >
                <div class="text-white notoSansJpAndFourteen font-bold">
                    {{ $store.getters.topManagementInfo.name.substring(0, 2) }}
                </div>
            </div>
            <!-- </div> -->
        ...
        <div
            :class="{
                'fixed top-0 left-0 right-0 bottom-0 bg-lock z-99': isDown,
            }"
        >
            <div
                v-if="isDown == true"
                class="flex justify-end items-center pt-2 space-x-2 mr-2"
            >
                <div class="">
                    <div
                        class="
            ...
            <div class="flex justify-center">
                <div
                    ...
                    v-if="isDown"
                >
                    <div class="h-45.75 pt-2.5 pb-2.5 space-y-2.5">
