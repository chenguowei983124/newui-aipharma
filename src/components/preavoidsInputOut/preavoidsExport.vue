<template>
  <div>
    <div
      class="organizationResult_header_bg_gray notoSansJpAndEighteenBold mt-5"
    >
      エクスポート
    </div>
    <div
    ...
    >
      <div class="pl-5 pt-5">
        各様式毎に症例データを、インポートフォーム(Microsoft Excel ファイル)
        でエクスポートします。
      </div>
      <div class="pl-5">
      ...
      <div class="flex pl-5 pt-2.5">
        <div class="flex items-center pr-5">
          <input
            type="radio"
            class="form-radio h-6 w-6 text-garyTitle ring-1 ring-grayline"
            v-model="radioVal"
            id=""
            name="radio"
            value="reportingAt"
        ...
        <div class="flex items-center">
          <input
            ...
            id=""
          />
          <div class="pl-2 notoSansJpAndFourteenMedium">システム登録日</div>
        </div>
      </div>
      <!-- 対象期間 -->
      <div class="flex space-x-2 pl-5 pt-2.5 pr-5">
        ...
        ></litepie-datepicker>
        <div class="w-8 text-black text-center mt-1.5 font-black">―</div>
        <litepie-datepicker
          ref="datepickerTo"
          :asSingle="true"
          i18n="ja"
