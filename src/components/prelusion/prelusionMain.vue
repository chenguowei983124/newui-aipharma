  ...
  <div>
      ...
      <div class="flex flex-col w-full md:w-191.25 mx-2 md:mx-0">
        <div class="flex justify-between pb-5 md:pb-3">
          <div class="pt-4">
            ...
            <div>
              <p class="break-words notoSansJpAndTwelveRegular mt-4 text-black">
                薬剤業務運営に役立つサービスのご紹介
              </p>
            </div>
          </div>
    ...
    <div class="flex">
      ...
      <div class="w-full md:w-191.25">
        <!-- タイトル -->
        <div
          class="h-10 notoSansJpAndSixteenMedium text-left mt-5 md:mt-10 mx-2"
        >
          ■関連
        </div>
        <!-- 明細 -->
        <div class="space-y-2">
          <div
            class="border-2 border-pageblue rounded-md mx-2 pt-2 md:pt-4"
          ...
          >
            ...
            <div class="pl-3.75 pr-3.75 mt-2">
              ...
              >
                <div
                  class=""
                  :class="[!item.detailDisp ? content.titlleStyle : 'block']"
                ...
                <div v-if="content.contentType == 'listDisc'">
                  <ul
                    ...
                    :key="contentItem"
                  >
                    <li :class="[!item.detailDisp ? contentItem.style : '']">
                      {{ contentItem.item }}
                    </li>
                  </ul>
                </div>
                <div v-if="content.contentType == 'listDecimal'">
                  <ol class="pl-5" :class="content.contentStyle">
                    <li
                      class="ist-decimal"
                      :class="[!item.detailDisp ? contentItem.style : '']"
                      v-for="contentItem in content.content"
                      :key="contentItem"
                    >
                      {{ contentItem.item }}
            ...
            >
              <triangle-down-svg
                class="w-3 h-3"
                :class="[item.detailDisp ? 'transform rotate-180' : '']"
                fill="#32a5dc"
                stroke="#32a5dc"
              ></triangle-down-svg>
              <div>
