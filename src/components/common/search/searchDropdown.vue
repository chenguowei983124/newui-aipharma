<template>
  <div class="z-75">
    <div
      class="flex justify-start items-center h-10 bg-searchBar cursor-pointer"
      @click="isDown = !isDown"
      ...
      <div v-for="item in itemList" :key="item">
        <div v-for="value in item" :key="value">
          ...
          <div v-if="value.id != checkedID" class="pl-2">
            <div class="flex hover:opacity-50" @click="itemClick(value)">
              <a class="w-4"></a>
          ...
          <!-- 選択したアイテム -->
          <div v-if="value.id == checkedID" class="pl-2">
            <div class="flex hover:text-googleTitle" @click="itemClick(value)">
