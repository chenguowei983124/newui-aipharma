      ...
      <div class="w-full md:w-191.25">
        ...
        >
          <div class="flex-none cs:flex-grow">
            ...
            <!-- 電話番号、サイトなど -->
            <div class="mt-1 notoSansJpAndTwelveRegular">■くすり相談窓口</div>

            <div class="notoSansJpAndSixteenBold text-view">
              {{ item.medicineCounter }}
            </div>

            <div class="mt-1 notoSansJpAndTwelveRegular">■資材請求</div>
            <div class="flex notoSansJpAndSixteenBold text-view">
              <div class="notoSansJpAndSixteenBold text-view">
                {{ item.infoCounter }}
              </div>

              <div class="ml-2 underline" v-if="item.webUrl !== ''">
          ...
          <div
            class="flex-none w-full pb-5 spm:w-50 lm:w-50 flex justify-center"
          >
            <div>
              <div
                class="
