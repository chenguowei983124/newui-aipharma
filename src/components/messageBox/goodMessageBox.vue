<template>
    <div class="flex flex-row h-21 bg-gray-500 justify-center items-center">
        <div class="flex justify-start space-x-2">
            <div class="w-82.5 h-3/4 border-0 px-0.5">
                <textarea
                    type="text"
                ...
                <div class="flex justify-between pr-2">
                    ...
                    <button class="bg-gray-600 text-white text-xs">送信</button>
                </div>
            </div>
            <div class="cursor-pointer" @click="openGoodMessageBox">
